import { candidates } from "shared/restrictedAssets";
import { BlurCreator } from "./blurCreator";
...
export function bindRecoilCam() {
    const Log = new Logger("super_shake_recoil");
    class CustomFreecam {
    ...
    Log.info("I am now making your recoil very cool")
}